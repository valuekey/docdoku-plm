...
@NamedQueries({
        ...
        @NamedQuery(name = "ProductBaseline.findObsoletePartRevisions", query = "SELECT bp.targetPart.partRevision FROM ProductBaseline b JOIN b.partCollection.baselinedParts bp WHERE b = :productBaseline AND bp.targetPart.partRevision.status = com.docdoku.core.product.PartRevision.RevisionStatus.OBSOLETE")
